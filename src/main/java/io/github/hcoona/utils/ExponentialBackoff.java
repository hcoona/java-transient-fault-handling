...
public class ExponentialBackoff extends RetryStrategy {
  ...
  private static double getRandomRange(double minValueIncluded,
      double maxValueExcluded) {
    return minValueIncluded
      + Math.random() * (maxValueExcluded - minValueIncluded + 1);
  }
